A basic weather, venues recommendation and news app demonstrating AJAX with simple fetch calls. Written in React, it makes use of router, React context, React hooks. Material UI used for CSS. 
